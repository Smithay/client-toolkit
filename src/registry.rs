    ...
    D: GlobalListHandler,
{
    ...
    fn new_global(
        ...
        let _ = (data, globals, conn, qh, global);
    }
...
macro_rules! registry_handlers {
    ($(@<$( $lt:tt $( : $clt:tt $(+ $dlt:tt )* )? ),+>)? $($ty:ty),* $(,)?) => {
        fn runtime_add_global(
            &mut self,
            globals: &$crate::reexports::client::globals::GlobalList,
            ...
            $(
                <$ty as $crate::registry::RegistryHandler<Self>>::new_global(self, globals, conn, qh, global);
            )*
        }
        ...
        fn runtime_remove_global(
            ...
            $(
                <$ty as $crate::registry::RegistryHandler<Self>>::remove_global(self, globals, conn, qh, global);
            )*
        }
    }
}
